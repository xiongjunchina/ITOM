...
验收基准为 `docs/03-PRD.md` 对应章节 + 各里程碑提交说明；实现细节以代码与测试（206 例）为准。
...
Acceptance baseline: the matching section of `docs/03-PRD.md` plus each milestone's commit message; code and the 206-case test suite are the source of truth.
