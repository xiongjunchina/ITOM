...
MODULES = [
    ...
    ("platform_portfolio", "平台服务与需求池", "平台运营"),
    ("platform_capacity", "平台容量与承诺", "平台运营"),
    ("platform_enablement", "平台赋能资产与目标", "平台运营"),
    ("platform_integrations", "平台外部系统与观测", "平台运营"),
    ("reports", "统一报表中心", "报表中心"),
...
_BUSINESS_VIEW = [
    ...
    "platform_portfolio", "platform_capacity",
]
...
DEFAULT_MATRIX: dict[str, dict[str, str]] = {
    ...
    "it_dev": _staff_base(),
    "it_bp": _merge(_staff_base(), {"requirements": "e", "platform_portfolio": "vc"}),
    "it_pdm": _merge(_staff_base(), {"requirements": "e", "task_bug": "vce",
                                      "platform_portfolio": "vce", "platform_capacity": "vce",
                                      "reports_platform": "v"}),
