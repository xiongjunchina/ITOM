...
ALL_ROLES = [ADMIN, CIO, IT_BM, IT_TM, IT_PDM, IT_PDM_LEADER, IT_PM, IT_PMO, IT_DEV, IT_DEV_LEADER, IT_OPS, IS_MGR, IT_BP, AUDITOR, REQUESTER]
TEAM_ROLES = [CIO, IT_BM, IT_TM, IT_PDM, IT_PDM_LEADER, IT_PM, IT_PMO, IT_DEV, IT_DEV_LEADER, IT_OPS, IS_MGR, IT_BP]  # 内部团队成员（可被派单）
