...
definition_id FK、seq、name、node_type（processing 处理节点 / approval 审批节点）、default_role（it_bp/it_pdm/it_pm/it_dev/it_ops/is_mgr/manager）、cc_roles（知会角色/用户组）、autonomy_level（L1-L4）、sla_hours、description。
