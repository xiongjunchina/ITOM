...
> 依据 [03-PRD.md](03-PRD.md)（v1.0 定稿）。共 **43 张表**：支撑 9、ITSM 12、项目 6、需求 2、流程 4、团队 10。
...
definition_id FK、seq、name、default_role（it_pm/it_pjm/it_dev/it_ops/is_mgr/manager）、autonomy_level（L1-L4）、sla_hours、description。
