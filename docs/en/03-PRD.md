...
| Web Agent WA0–WA4 (design approved; WA0 Tasks 1–3 implemented, Task 4+ pending) | 2, 3, 5–10, 11 | Persistence, fixed capability/live policy/redaction, and the secure model gateway are implemented; model/profile administration, the role-aware read-only advisor, requester service-request and BDO requirement loops, controlled IT-staff writes, and quality governance continue by phase; ITOM permission/domain services remain authoritative |
