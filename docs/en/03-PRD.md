...
### 10.1 ITOM Web Agent (design approved; WA0 Tasks 1–5 implemented)
...
| Web Agent WA0–WA4 (design approved; WA0 Tasks 1–5 implemented, Task 6+ pending) | 2, 3, 5–10, 11 | Persistence, fixed capability/live policy/redaction, the secure model gateway, provider/profile administration APIs, and owner-scoped web-conversation lifecycle are implemented; the administration UI, SSE/actions, role-aware read-only advisor, requester service-request and BDO requirement loops, controlled IT-staff writes, and quality governance continue by phase; ITOM permission/domain services remain authoritative |
