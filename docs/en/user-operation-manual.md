...
- **Users & Groups**: manage accounts, linked people, roles, groups, status, provisioning, and initial passwords. Clearing Linked Person and saving persists an unlinked account after refresh; it does not delete the person, department placement, group membership, or history. Groups represent professional resource pools and can grant roles.
