...
export const MENU_TREE: MenuNode[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { key: '/admin/provision-rules', path: '/admin/provision-rules', label: '开通规则', roles: ['admin'] },
      { key: '/admin/departments', path: '/admin/departments', label: '部门管理', roles: ['admin'] },
      { key: '/admin/members', path: '/admin/members', label: '人员主数据', roles: ['admin'] },
      { key: '/admin/business-domains', path: '/admin/business-domains', label: '业务域', roles: ['admin'] },
