...
const ROLE_ZH: M = { admin: '系统管理员', cio: 'CIO(IT总负责人)', it_bm: 'IT业务线负责人', it_tm: 'IT专业线负责人', it_pdm: 'IT产品经理', it_pm: 'IT项目经理', it_dev: 'IT开发', it_ops: 'IT运维', is_mgr: '信息安全管理员', it_bp: 'IT业务合作伙伴', auditor: '审计员', requester: '业务用户' };
const ROLE_EN: M = { admin: 'Administrator', cio: 'CIO (Head of IT)', it_bm: 'IT Business-line Lead', it_tm: 'IT Discipline-line Lead', it_pdm: 'IT Product Manager', it_pm: 'IT Project Manager', it_dev: 'IT Developer', it_ops: 'IT Operations', is_mgr: 'Information Security Manager', it_bp: 'IT Business Partner', auditor: 'Auditor', requester: 'Requester' };
...
const WORKFLOW_ENTITY_ZH: M = { ticket: '工单（事件/服务请求）', ticket_change: '工单（变更）' };
const WORKFLOW_ENTITY_EN: M = { ticket: 'Ticket (Incident/Service Request)', ticket_change: 'Ticket (Change)' };
...
const WBS_STATUS_EN: M = { 未开始: 'Not started', 进行中: 'In progress', 已完成: 'Done' };
