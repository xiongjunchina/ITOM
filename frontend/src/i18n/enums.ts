...
const WORKFLOW_ENTITY_ZH: M = { ticket: '工单（事件/服务请求）', ticket_change: '工单（变更）', requirement: '需求', project: '项目', problem: '问题', bug: 'Bug 管理' };
const WORKFLOW_ENTITY_EN: M = { ticket: 'Ticket (Incident/Service Request)', ticket_change: 'Ticket (Change)', requirement: 'Requirement', project: 'Project', problem: 'Problem', bug: 'Bug Management' };
...
const POINT_SOURCE_ZH: M = { ticket_resolved: '工单解决', ticket_sla_met: 'SLA达成', ticket_satisfaction: '满意度好评', idea_submit: '建言', idea_like: '被点赞', idea_adopt: '建言采纳', wbs_done_on_time: '任务按期', milestone_achieved: '里程碑', requirement_task_done: '需求任务', requirement_closed: '需求交付', bug_fix_task_done: 'Bug修复任务', delegated_work_done: '委派任务', work_task_learning_growth: '委派任务·学习成长', work_task_cross_team_support: '委派任务·跨团队支持', work_task_training_knowledge: '委派任务·培训知识', knowledge_published: '发布知识', knowledge_voted: '知识好评', training_host: '主讲培训', training_attend: '参与培训', campaign_award: '专项活动', learning_growth: '学习成长' };
const POINT_SOURCE_EN: M = { ticket_resolved: 'Ticket resolved', ticket_sla_met: 'SLA met', ticket_satisfaction: 'Satisfaction', idea_submit: 'Suggestion', idea_like: 'Liked', idea_adopt: 'Suggestion adopted', wbs_done_on_time: 'Task on time', milestone_achieved: 'Milestone', requirement_task_done: 'Req task', requirement_closed: 'Req delivered', bug_fix_task_done: 'Bug fix task', delegated_work_done: 'Delegated task', work_task_learning_growth: 'Delegated task · learning', work_task_cross_team_support: 'Delegated task · cross-team support', work_task_training_knowledge: 'Delegated task · training/knowledge', knowledge_published: 'Published KB', knowledge_voted: 'KB helpful', training_host: 'Training host', training_attend: 'Training attend', campaign_award: 'Campaign', learning_growth: 'Learning and growth' };
...
const PROC_ENTITY_ZH: M = { ticket: '工单', ticket_change: '变更', problem: '问题', project: '项目', requirement: '需求', bug: 'Bug 管理' };
const PROC_ENTITY_EN: M = { ticket: 'Ticket', ticket_change: 'Change', problem: 'Problem', project: 'Project', requirement: 'Requirement', bug: 'Bug Management' };
...
const REQUIREMENT_STATUS_ZH: M = { registered: '已登记', supplementing: '待登记人补充', evaluating: '评估中', analyzing: '分析中', implementing: '实现中', closed: '已关闭', on_hold: '已搁置', cancelled: '已取消' };
const REQUIREMENT_STATUS_EN: M = { registered: 'Registered', supplementing: 'Awaiting requester update', evaluating: 'Evaluating', analyzing: 'Analyzing', implementing: 'Implementing', closed: 'Closed', on_hold: 'On hold', cancelled: 'Cancelled' };
