...
const POINT_SOURCE_EN: M = { ticket_resolved: 'Ticket resolved', ticket_sla_met: 'SLA met', ticket_satisfaction: 'Satisfaction', idea_submit: 'Suggestion', idea_like: 'Liked', idea_adopt: 'Suggestion adopted', wbs_done_on_time: 'Task on time', milestone_achieved: 'Milestone', requirement_task_done: 'Req task', requirement_closed: 'Req delivered', knowledge_published: 'Published KB', knowledge_voted: 'KB helpful', training_host: 'Training host', training_attend: 'Training attend', campaign_award: 'Campaign', learning_growth: 'Learning and growth' };
