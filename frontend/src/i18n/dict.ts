...
const zh: Dict = {
  ...
  'comp.pending.commentRequired': '请填写处理说明',
  'comp.pending.commentPlaceholder': '处理说明（将记入流程记录）',
...
const en: Dict = {
  ...
  'comp.pending.commentRequired': 'Please enter a note',
  'comp.pending.commentPlaceholder': 'Handling note (recorded in the process log)',
