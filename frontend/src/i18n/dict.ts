...
const zh: Dict = {
  ...
  'module.portfolio_governance': '组合治理（目标/成员/依赖）',
  'module.portfolio_scoring': '组合评分',
  'module.portfolio_decision': '组合决策与基线',
  'module.portfolio_resource': '组合资源承诺',
  'module.portfolio_audit': '组合治理审计',
...
const en: Dict = {
  ...
  'module.portfolio_governance': 'Portfolio Governance',
  'module.portfolio_scoring': 'Portfolio Scoring',
  'module.portfolio_decision': 'Portfolio Decisions & Baselines',
  'module.portfolio_resource': 'Portfolio Resource Commitments',
  'module.portfolio_audit': 'Portfolio Governance Audit',
